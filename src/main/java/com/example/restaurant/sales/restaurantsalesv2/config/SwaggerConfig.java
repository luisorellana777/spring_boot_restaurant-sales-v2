...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
	...
	public Docket swaggerPlugin() {
		return new Docket(DocumentationType.SWAGGER_2).select().paths(PathSelectors.any())
				.apis(Predicates.or(RequestHandlerSelectors
						.basePackage("com.example.restaurant.sales.restaurantsalesv2.controller")))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Api Restaurant Prices").description(
				"This is an api wich allows to insert sales and its productos into Mysql DB, and testing RabbitMq queue")
